...
public class UPDATE {
    ...
    public void update() {
        ...
        try {
            ...
            dropdown.selectByVisibleText("PUT");
            ...
            urlElement.clear();
            urlElement.sendKeys("https://gorest.co.in/public/v2/users/7794014");
         ...
         // Insert the body with the correct message
            bodyElement.sendKeys("{"
            		+ "  \"name\": \"Testing1\","
            		+ "  \"email\": \"testing_testing@testing1.example\","
            		+ "  \"gender\": \"female\","
            		+ "  \"status\": \"active\""
            		+ "}");
            ...
            System.out.println("Expected : 201");
